...
var Y3 = (() => {
  ...
  return function(i = {}) {
    ...
    var i1 = u.wasmBinary, K, l1 = false, _1, z, O, n1, Z, M, C, g1, w1;
    function s1() {
      var t = K.buffer;
      u.HEAP8 = z = new Int8Array(t), u.HEAP16 = n1 = new Int16Array(t), u.HEAPU8 = O = new Uint8Array(t), u.HEAPU16 = Z = new Uint16Array(t), u.HEAP32 = M = new Int32Array(t), u.HEAPU32 = C = new Uint32Array(t), u.HEAPF32 = g1 = new Float32Array(t), u.HEAPF64 = w1 = new Float64Array(t);
    }
    var k1 = [], x = [], L1 = [];
    function n3() {
    ...
    }, X1 = u.noExitRuntime || true, M2 = typeof TextDecoder < "u" ? new TextDecoder() : void 0, T1 = function() {
    ...
    var f1 = {}, h1 = {}, W1 = {}, b1, a1 = (t, e, a) => {
      ...
      for (var e = ""; O[t]; ) e += C2[O[t++]];
      return e;
    }, L;
    function h3(t, e) {
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      var r = e.name;
      if (!t) throw new L(`type "${r}" must have a positive integer typeid pointer`);
      if (h1.hasOwnProperty(t)) {
        if (a.hb) return;
        throw new L(`Cannot register type '${r}' twice`);
      }
    ...
    var Z1 = (t) => {
      throw new L(t.Aa.Da.Ba.name + " instance already deleted");
    }, t2 = false, b2 = () => {
    ...
    var S1 = (t, e) => Object.defineProperty(e, "name", { value: t }), P2 = (t, e, a) => {
      if (t[e].Ea === void 0) {
        ...
        t[e] = function() {
          ...
          if (!t[e].Ea.hasOwnProperty(o.length)) throw new L(`Function '${a}' called with an invalid number of arguments (${o.length}) - expects one of (${t[e].Ea})!`);
          return t[e].Ea[o.length].apply(this, o);
        }, t[e].Ea = [], t[e].Ea[r.Na] = r;
      }
    }, e2 = (t, e, a) => {
      if (u.hasOwnProperty(t)) {
        if (a === void 0 || u[t].Ea !== void 0 && u[t].Ea[a] !== void 0) throw new L(`Cannot register public name '${t}' twice`);
        if (P2(u, t, t), u[t].Ea.hasOwnProperty(a)) throw new L(`Cannot register multiple overloads of a function with the same number of arguments (${a})!`);
        u[t].Ea[a] = e;
      } else u[t] = e, u[t].Na = a;
    }, c3 = (t) => {
    ...
    var i2 = (t, e, a) => {
      for (; e !== a; ) {
        if (!e.Qa) throw new L(`Expected null or instance of ${a.name}, got an instance of ${e.name}`);
        t = e.Qa(t), e = e.Ga;
      }
      return t;
    };
    function _3(t, e) {
      if (e === null) {
        if (this.Ta) throw new L(`null is not a valid ${this.name}`);
        return 0;
      }
      if (!e.Aa) throw new L(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new L(`Cannot pass deleted object as a pointer of type ${this.name}`);
    ...
    function f3(t, e) {
      ...
      if (!e || !e.Aa) throw new L(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new L(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.Ra && e.Aa.Da.Ra) throw new L(`Cannot convert argument of type ${e.Aa.Ha ? e.Aa.Ha.name : e.Aa.Da.name} to parameter type ${this.name}`);
      if (a = i2(e.Aa.Ca, e.Aa.Da.Ba, this.Ba), this.Sa) {
        if (e.Aa.Fa === void 0) throw new L("Passing raw pointer to smart pointer is illegal");
        switch (this.ob) {
          case 0:
            if (e.Aa.Ha === this) a = e.Aa.Fa;
            else throw new L(`Cannot convert argument of type ${e.Aa.Ha ? e.Aa.Ha.name : e.Aa.Da.name} to parameter type ${this.name}`);
            break;
          case 1:
            a = e.Aa.Fa;
            break;
    ...
    function v3(t, e) {
      ...
      if (!e.Aa) throw new L(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new L(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (e.Aa.Da.Ra) throw new L(`Cannot convert argument of type ${e.Aa.Da.name} to parameter type ${this.name}`);
      return i2(e.Aa.Ca, e.Aa.Da.Ba, this.Ba);
    }
    ...
    var O2 = (t, e, a) => {
      ...
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
      return t.includes("j") ? (t = t.replace(/p/g, "i"), e = (0, u["dynCall_" + t])(e, ...a)) : e = U.get(e)(...a), e;
    }, p3 = (t, e) => function() {
      ...
      if (typeof a != "function") throw new L(`unknown function pointer with signature ${t}: ${e}`);
      return a;
    }, E2, A2 = (t) => {
      t = B2(t);
      var e = A(t);
      ...
      var r = [], s = {};
      throw e.forEach(a), new E2(`${t}: ` + r.map(A2).join([", "]));
    }, n2 = (t, e) => {
    ...
    function a2(t, e, a, r, s) {
      var o = e.length;
      if (2 > o) throw new L("argTypes array size mismatch! Must at least get return value and 'this' types!");
    ...
    var k2 = (t) => {
      ...
      var a = h1[t];
      if (a === void 0) throw t = `${e} has unknown type ${A2(t)}`, new L(t);
      return a;
    }, o2 = (t) => {
      ...
      if (a <<= 1, 32 < a - t && F2) return F2.decode(O.subarray(t, a));
      for (a = "", r = 0; !(r >= e / 2); ++r) {
        var s = n1[t + 2 * r >> 1];
        if (s == 0) break;
      ...
      return a;
    }, k3 = Reflect.construct, O1 = {}, R2 = (t) => {
      if (!(t instanceof L2 || t == "unwind")) throw t;
    }, W2 = (t) => {
      var e;
      throw _1 = t, X1 || 0 < h2 || ((e = u.onExit) !== null && e !== void 0 && e.call(u, t), l1 = true), new L2(t);
    }, D3 = (t) => {
      if (!l1) try {
        if (t(), !(X1 || 0 < h2)) try {
          _1 = t = _1, W2(t);
    ...
    for (var $2 = Array(256), j1 = 0; 256 > j1; ++j1) $2[j1] = String.fromCharCode(j1);
    C2 = $2, L = u.BindingError = class extends Error {
      constructor(t) {
      ...
      if (this.Aa.Ca || Z1(this), this.Aa.Oa && !this.Aa.Pa) throw new L("Object already scheduled for deletion");
      b2(this);
      var t = this.Aa;
...
` + r.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var T3 = { c: (t, e, a, r) => D1(`Assertion failed: ${t ? T1(t) : ""}, at: ` + [e ? e ? T1(e) : "" : "unknown filename", a, r ? r ? T1(r) : "" : "unknown function"]), j: (t, e, a) => {
      ...
      a1([t], o, (l) => {
        ...
        return s.forEach((f, m) => {
          var v = l[m], y = f.eb, b = f.fb, $ = l[m + s.length], S = f.lb, H = f.nb;
          c[f.ab] = { read: (R) => v.fromWireType(y(b, R)), write: (R, P) => {
            var T = [];
            S(H, R, $.toWireType(T, P)), Y1(T);
          } };
      ...
      var $ = c3(v);
      e2($, function() {
        $1(`Cannot construct ${v} due to unbound types`, [r]);
      }), a1([t, e, a], r ? [r] : [], (S) => {
        if (S = S[0], r) var H = S.Ba, R = H.Ma;
        else R = U1.prototype;
        S = S1(v, function() {
          if (Object.getPrototypeOf(this) !== P) throw new L("Use 'new' to construct " + v);
          if (T.La === void 0) throw new L(v + " has no accessible constructor");
          for (var N2 = arguments.length, N1 = new Array(N2), G1 = 0; G1 < N2; G1++) N1[G1] = arguments[G1];
          var G2 = T.La[N1.length];
          if (G2 === void 0) throw new L(`Tried to invoke ctor of ${v} with invalid number of parameters (${N1.length}) - expected (${Object.keys(T.La).toString()}) parameters instead!`);
        ...
        if (T.Ga) {
          var H2, E1;
          (H2 = (E1 = T.Ga).Va) !== null && H2 !== void 0 || (E1.Va = []), T.Ga.Va.push(T);
        }
        return H = new P1(v, T, true, false, false), E1 = new P1(v + "*", T, false, false, false), R = new P1(v + " const*", T, false, true, false), S2[t] = { pointerType: E1, Za: R }, O2($, S), [H, E1, R];
      });
    }, r: (t, e, a, r, s, o) => {
      var l = n2(e, a);
      s = F(r, s), a1([], [t], (c) => {
        ...
        if (c.Ba.La === void 0 && (c.Ba.La = []), c.Ba.La[e - 1] !== void 0) throw new L(`Cannot register multiple constructors with identical number of parameters (${e - 1}) for class '${c.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return c.Ba.La[e - 1] = () => {
          $1(`Cannot construct ${c.name} due to unbound types`, l);
      ...
      e = A(e), e = k2(e), o = F(s, o), a1([], [t], (m) => {
        function v() {
          $1(`Cannot call ${y} due to unbound types`, f);
        }
        m = m[0];
        var y = `${m.name}.${e}`;
        e.startsWith("@@") && (e = Symbol[e.substring(2)]), c && m.Ba.jb.push(e);
        var b = m.Ba.Ma, $ = b[e];
        return $ === void 0 || $.Ea === void 0 && $.className !== m.name && $.Na === a - 2 ? (v.Na = a - 2, v.className = m.name, b[e] = v) : (P2(b, e, y), b[e].Ea[a - 2] = v), a1([], f, (S) => (S = a2(y, S, m, o, l), b[e].Ea === void 0 ? (S.Na = a - 2, b[e] = S) : b[e].Ea[a - 2] = S, [])), [];
      });
      ...
      t = A(t), t = k2(t), s = F(r, s), e2(t, function() {
        $1(`Cannot call ${t} due to unbound types`, l);
      }, e - 1), a1([], l, (c) => (O2(t, a2(t, [c[0], null].concat(c.slice(1)), null, s, o), e - 1), []));
    }, n: (t, e, a, r, s) => {
      ...
      j(t, { name: e, fromWireType: s, toWireType: l, Ia: 8, readValueFromPointer: M3(e, a, r !== 0), Ja: null });
    }, g: (t, e, a) => {
      function r(o) {
      ...
      e = A(e), j(t, { name: e, fromWireType: function(a) {
        for (var r = C[a >> 2], s = a + 4, o, l = s, c = 0; c <= r; ++c) {
          var f = s + c;
          (c == r || O[f] == 0) && (l = l ? T1(l, f - l) : "", o === void 0 ? o = l : (o += "\0", o += l), l = f + 1);
        }
        return e1(a), o;
      }, toWireType: function(a, r) {
        r instanceof ArrayBuffer && (r = new Uint8Array(r));
        var s, o = typeof r == "string";
        if (!(o || r instanceof Uint8Array || r instanceof Uint8ClampedArray || r instanceof Int8Array)) throw new L("Cannot pass non-string to std::string");
        ...
        if (l = l2(4 + s + 1), c = l + 4, C[l >> 2] = s, o) y1(r, c, s + 1);
          ...
          if (255 < f) throw e1(c), new L("String has UTF-16 code units that do not fit in 8 bits");
          O[c + o] = f;
        }
        else for (o = 0; o < s; ++o) O[c + o] = r[o];
      ...
      else e === 4 && (r = S3, s = P3, o = O3, l = (c) => C[c >> 2]);
      j(t, { name: a, fromWireType: (c) => {
        ...
        if (typeof f != "string") throw new L(`Cannot pass non-string to C++ string type ${a}`);
      ...
      t--;
      var o = Array(t);
      return e = `methodCaller<(${r.map((l) => l.name).join(", ")}) => ${s.name}>`, E3(S1(e, (l, c, f, m) => {
      ...
      var a = setTimeout(() => {
        delete O1[t], D3(() => z2(t, performance.now()));
      }, e);
      return O1[t] = { id: a, qb: e }, 0;
    }, H: (t, e, a, r) => {
      var s = (/* @__PURE__ */ new Date()).getFullYear(), o = new Date(s, 0, 1).getTimezoneOffset();
      s = new Date(s, 6, 1).getTimezoneOffset(), C[t >> 2] = 60 * Math.max(o, s), M[e >> 2] = +(o != s), e = (l) => {
        var c = Math.abs(l);
    ...
    }, S: () => 52, Q: () => 52, l: R3, f: $3, e: j3, B: W3, aa: z3, a: x3, b: B3, h: U3, t: H3, U: W2, L: (t, e) => (U2(O.subarray(t, t + e)), 0) }, I;
    (async function(t, e) {
      function a(o) {
        var l;
        return I = o.exports, K = I.da, s1(), U = I.ga, x.unshift(I.ea), o1--, (l = u.monitorRunDependencies) === null || l === void 0 || l.call(u, o1), o1 == 0 && M1 && (o = M1, M1 = null, o()), I;
      }
...
function d1() {
  return 1 + ((E ? window.devicePixelRatio : 1) - 1) * Q3;
}
function m1(h) {
...
var e3 = class g {
  ...
  load(i) {
    this._dotLottieCore === null || g._wasmModule === null || (this._stopAnimationLoop(), E && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas), this._cleanupStateMachineListeners()), this._isFrozen = false, this._dotLottieCore.setConfig({ animationId: i.animationId ?? "", themeId: i.themeId ?? "", stateMachineId: "", autoplay: i.autoplay ?? false, backgroundColor: 0, loopAnimation: i.loop ?? false, loopCount: i.loopCount ?? 0, mode: f2(i.mode ?? "forward", g._wasmModule), segment: v2(i.segment ?? [], g._wasmModule), speed: i.speed ?? 1, useFrameInterpolation: i.useFrameInterpolation ?? true, marker: i.marker ?? "", layout: m2(i.layout, g._wasmModule) }), i.data ? this._loadFromData(i.data) : i.src && this._loadFromSrc(i.src), this.setBackgroundColor(i.backgroundColor ?? ""));
  }
  _draw() {
  ...
  play() {
    this._dotLottieCore === null || !this.isLoaded || (this._stopAnimationLoop(), (this._dotLottieCore.play() || this._dotLottieCore.isPlaying()) && (this._isFrozen = false, this._startAnimationLoop()), E && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !m1(this._canvas) && this.freeze());
  }
  pause() {
  ...
  setBackgroundColor(i) {
    this._dotLottieCore !== null && (E && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = i : this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), backgroundColor: e0(i) }), this._backgroundColor = i);
  }
  setLoop(i) {
  ...
  destroy() {
    var _a, _b, _c, _d;
    this._stopAnimationLoop(), this._isStateMachineRunning = false, E && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas)), this._stateMachineObserverHandle && ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineUnsubscribe(this._stateMachineObserverHandle), this._stateMachineObserverHandle.delete(), this._stateMachineObserverHandle = null), this._stateMachineInternalMessageObserver && ((_b = this._dotLottieCore) == null ? void 0 : _b.stateMachineInternalUnsubscribe(this._stateMachineInternalMessageObserver), this._stateMachineInternalMessageObserver.delete(), this._stateMachineInternalMessageObserver = null), this._dotLottieObserverHandle && ((_c = this._dotLottieCore) == null ? void 0 : _c.unsubscribe(this._dotLottieObserverHandle), this._dotLottieObserverHandle.delete(), this._dotLottieObserverHandle = null), (_d = this._dotLottieCore) == null ? void 0 : _d.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: "destroy" }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  _setupStateMachineObservers() {
    ...
    n.setOnMessage((d) => {
      E ? d.startsWith("OpenUrl: ") && t3(d) : this._eventManager.dispatch({ type: "stateMachineInternalMessage", message: d });
...
var g2 = class r1 {
  ...
  async play() {
    this._created && (await this._sendMessage("play", { instanceId: this._id }), await this._updateDotLottieInstanceState(), E && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !m1(this._canvas) && await this.freeze());
  }
  async pause() {
  ...
  async destroy() {
    this._created && (this._created = false, await this._sendMessage("destroy", { instanceId: this._id }), this._cleanupStateMachineListeners(), r1._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), E && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas)));
  }
  async freeze() {
...
var J1 = g2;
var K1 = ({ animationId: h, autoplay: i, backgroundColor: n, className: d, createDotLottie: _, data: w, dotLottieRefCallback: u, layout: W, loop: V, mode: J, playOnHover: p1, renderConfig: u1, segment: D, speed: c1, src: q, stateMachineConfig: i1, stateMachineId: K, style: l1, themeData: _1, themeId: z, useFrameInterpolation: O, workerId: n1, ...Z }) => {
  let M = (0, import_react.useRef)(null), C = (0, import_react.useRef)(null), g1 = (0, import_react.useRef)(u), w1 = { speed: c1, mode: J, loop: V, useFrameInterpolation: O, segment: D, backgroundColor: n, autoplay: i, themeId: z, workerId: n1, src: q, data: w, layout: W, renderConfig: u1, animationId: h, stateMachineConfig: i1, stateMachineId: K }, s1 = (0, import_react.useRef)(w1);
  g1.current = u, s1.current = w1;
  let k1 = (0, import_react.useCallback)((x) => {
    var _a, _b;
    C.current = x, x ? M.current = _({ ...s1.current, canvas: x }) : ((_a = M.current) == null ? void 0 : _a.destroy(), M.current = null), (_b = g1.current) == null ? void 0 : _b.call(g1, M.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    var _a, _b;
    let x = (L1) => {
      var _a2, _b2;
      p1 && (L1.type === "mouseenter" && ((_a2 = M.current) == null ? void 0 : _a2.play()), L1.type === "mouseleave" && ((_b2 = M.current) == null ? void 0 : _b2.pause()));
    };
    ...
    var _a;
    (_a = M.current) == null ? void 0 : _a.setSpeed(c1 ?? 1);
  }, [c1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = M.current) == null ? void 0 : _a.setMode(J ?? "forward");
  }, [J]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = M.current) == null ? void 0 : _a.setLoop(V ?? false);
  }, [V]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = M.current) == null ? void 0 : _a.setUseFrameInterpolation(O ?? true);
  }, [O]), (0, import_react.useEffect)(() => {
    var _a;
    typeof (D == null ? void 0 : D[0]) == "number" && typeof D[1] == "number" && ((_a = M.current) == null ? void 0 : _a.setSegment(D[0], D[1]));
  }, [D]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = M.current) == null ? void 0 : _a.setBackgroundColor(n ?? "");
  }, [n]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = M.current) == null ? void 0 : _a.setRenderConfig(u1 ?? {});
  }, [JSON.stringify(u1)]), (0, import_react.useEffect)(() => {
    var _a;
    typeof w != "string" && typeof w != "object" || ((_a = M.current) == null ? void 0 : _a.load({ data: w, ...s1.current }));
  }, [w]), (0, import_react.useEffect)(() => {
    var _a;
    typeof q == "string" && ((_a = M.current) == null ? void 0 : _a.load({ src: q, ...s1.current }));
  }, [q]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = M.current) == null ? void 0 : _a.setMarker(Z.marker ?? "");
  }, [Z.marker]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = M.current) == null ? void 0 : _a.loadAnimation(h ?? "");
  }, [h]), (0, import_react.useEffect)(() => {
    var _a;
    typeof z == "string" && ((_a = M.current) == null ? void 0 : _a.setTheme(z));
  }, [z]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = M.current) == null ? void 0 : _a.setThemeData(_1 ?? "");
  }, [_1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = M.current) == null ? void 0 : _a.setLayout(W ?? {});
  }, [W == null ? void 0 : W.fit, (W == null ? void 0 : W.align) && W.align[0], (W == null ? void 0 : W.align) && W.align[1]]), (0, import_react.useEffect)(() => {
    var _a;
    ((_a = M.current) == null ? void 0 : _a.isLoaded) && (typeof K == "string" && K ? M.current.stateMachineLoad(K) && M.current.stateMachineStart() : M.current.stateMachineStop());
  }, [K]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = M.current) == null ? void 0 : _a.stateMachineSetConfig(i1 ?? null);
...
var h0 = (h) => new V1(h);
var E0 = (h) => (0, import_jsx_runtime.jsx)(K1, { ...h, createDotLottie: h0 });
var u0 = (h) => new J1(h);
